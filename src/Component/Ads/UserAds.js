                    ...
                    <div className="classes" >
                        <Alert color="success">
                            ...
                            <div className="saymyname" >
                                <p className="date-remu">

                                    <h6>Date: </h6> <h6>Réumunération:</h6>
                                </p>
                                <div className="">
                                    <Button className="clickme1 modifiier" >Modifier</Button>{' '}
                                </div>
                                <div className="">
                                    <Button className="clickme1" >Supprimer</Button>{' '}
                                </div>
                            </div>
                            <div className="stars-clik">
                                <Button className="colors" onClick={this.toggle} style={{ marginBottom: '1rem' }}>Personne interéssées</Button>
